...
def AnnualMaximumBenefits(maximums):
    if len(maximums)!=0:
        ...
        for obj in maximums:
            if (obj['Type'] =='Calendar Individual Maximum' or obj['Type']=="Contract Individual Maximum" or obj['Type']=="Carryover Individual Maximum") and "PPO" in obj['Network'] and "Restorative" in obj['ProgramMaximum_AppliesToTheFollowingServices_']:
                return  float(fixna(obj['Amount']).replace("$",""))
    else:
        return None    
