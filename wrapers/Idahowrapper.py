...
#     with open("newJsonidahoPDFoutput.json", "w") as jsonFile:
...
def main(Scraperdata, request):
        ...
        for provision_list in EligibilityOtherProvisions:
            for provision in provision_list:
                ...
                if 'Composite' in plansummary:
                    value = provision['Plansummary'].split('Composite')[1].split('.')[0]
    ...
    try:
        ...
        for i in range(len(EligibilityMaximiums) - 1):
            if EligibilityMaximiums[i]["Benefit Information"] == "Individual Annual Deductible: ":
                ...
                ppo_value = EligibilityMaximiums[i + 1]["PPO"]
                break
        ...
        IndividualAnnualdeductible_value = IndividualAnnualdeductible_dict.get("PPO")
    ...
    try:
        ...
        familyAnnualdeductible_value = familyAnnualdeductible_dict.get("PPO")
        # print(IndividualAnnualdeductible_value)          
    ...
    try:
        ...
        individualannualmax_value = individualannualmax_dict.get("PPO")
    ...
    try:
        ...
        ortholifetime_value = ortholifetimemax_dict.get("PPO")
