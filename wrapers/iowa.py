...
def main(Scraperdata, request):
    ...
    for benefits in EligibilityBenefitsData:
        ...
        EligibilityBenefits.append({
            ...
            "Amount": "",
            "Type": "",
            "limitation": str(frequency+", "+limitationsText+ ", Age limit "+benefits.get("AgeLimitPPO")).strip(", "),
...
# data=json.load(open(r"C:\Users\iamha\Desktop\BPK teck\All Payors\SDB EXTERNAL\dev 15 june all testing\dev 17 june\SD%20Payor%20Scraping\output_230623_121828_.json", 'r'))
